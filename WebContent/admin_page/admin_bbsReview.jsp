    	   	...
    	   	<div class="board_container">
    			...
    			<form method="post" action="admin_bbsDel.jsp?bbsType=3"> 			
            		<div class="board_row">
            			<table class="board_table">
	            			...
	            			<tbody>   			
	            			<%
	            				ArrayList<Bbs_review> list = new BbsDAO_review().getReview(pageNumber);
            	...
            	%>
            		<div class="board_page-move-symbol-left">
            			<a href="admin_bbsReview.jsp?pageNumber=<%=pageNumber-1 %>" class="link"> ◀ 이전 페이지 </a>
					</div>
				<% 
					}
            		if(new BbsDAO_review().admin_nextPage("bbs_review", pageNumber+1)){
				%>
					<div class="board_page-move-symbol-right">
            			<a href="admin_bbsReview.jsp?pageNumber=<%=pageNumber+1 %>" class="link"> 다음 페이지 ▶ </a>
            		</div>
            	<%
            		}
            	%>
