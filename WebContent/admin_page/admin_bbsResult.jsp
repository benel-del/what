        ...
        <section>
    		...
    		<div class="board_container">
    			...
    			<form method="post" action="admin_bbsDel.jsp?bbsType=2"> 			
            			...
            			<table class="board_table">
	            			...
	            			%>
	            				...
	            				<tr class="board_tr"">
	            					...
	            					<td><a href="result_view.jsp?bbsID=<%=list.get(i).getBbsID()%>"><%=list.get(i).getBbsTitle() %></a></td>
	            					<td></td>
	            	...
	            	<div class="admin_btn">
	    				<button type="submit" formaction="admin_bbsDelAction.jsp?bbsType=2&available=0">글 삭제</button>
	    				<button type="submit" formaction="admin_bbsDelAction.jsp?bbsType=2&available=1">글 복구</button>
	    			</div> 				
    			</form>	
