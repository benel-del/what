    ...
    <div id="wrapper">
    	<section class="container">
    	   	<div class="admin_subtitle">
    			<h6>게시물관리 - <a href="admin_bbsReview.jsp">후기게시물조회</a> - <a href="review_select.jsp">모임 선택</a></h6>
    		</div>  
    		<br>

           	<div class="login_page">
              	<form method="get" action="review_write.jsp">
              		<div class="login_header">
                   		<a href="review_select.jsp">후기게시물 작성</a>
               		</div>
               		...
               		<input type="submit" class="login_submit-btn" value="후기 작성하기" >
          	 	</form>
             </div>
        </section>
    </div>
